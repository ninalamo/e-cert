...
**Version:** 1.7
**Status:** Final
**Layer:** `features/events` (UI honors; enforcement in Cert API)
**Audience:** Engineers, AI Development Agents

> **Related:** `specs/features/template-visibility.md` (sibling pattern, not the same rule),
> `specs/services/auth.md`, `specs/services/platform.md`.

...
**Version:** 1.1
**Status:** Final
**Layer:** `features/templates` (UI honors; enforcement in Cert API)
**Audience:** Engineers, AI Development Agents

> **Related:** `specs/services/auth.md` (role derivation), `specs/services/platform.md`.
...
- Role derivation (`specs/services/auth.md`)
...
Role resolution details live in `specs/services/auth.md`; this spec consumes its outputs, it does not re-derive them.

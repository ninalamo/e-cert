...
- Name: e2e\tests\auth\auth-flow.spec.ts >> Auth flow - SSO callback >> SSO callback failure shows error
- Location: e2e\tests\auth\auth-flow.spec.ts:17:7
...
Call log:
  - navigating to "/#payload=invalid", waiting until "load"
